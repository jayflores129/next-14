    ...
    >
      {pages.map((item, key) => (
        <a
          ...
          className={cn(
            "px-3.5 py-1.5 rounded-md font-medium text-xxsurface-foreground bg-xxsurface hover:opacity-80",
            itemClassName,
            item.active &&
              "bg-stone-950 text-stone-100 hover:bg-stone-800 hover:text-stone-200"
          )}
        >
          {item.label}
        </a>
