...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-md border border-stone-200 bg-white p-1 text-stone-950 shadow-md dark:border-stone-800 dark:bg-xxsurface dark:text-stone-50",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center text-xxsurface-foreground gap-2 rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-xxmenuHover/50 focus:text-stone-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0 dark:focus:bg-stone-800 dark:focus:text-stone-50",
      inset && "pl-8",
      className
    )}
    {...props}
